...
// Add a circle as marker to the map
L.circleMarker([34.0522, -118.2437], {
    radius: 300,
    color: "black",
    fillColor: "#ffffa1"
 }).addTo(map);
// Alternative code to create circle
// L.circle([34.0522, -118.2437]).addTo(map);

// Skill Drill: create a light-yellow circle with black lines 
