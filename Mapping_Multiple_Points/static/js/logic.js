...
// Replace marker variable to map multiple locations
...
// with a lineweight of 4, a radius where the population number is decreased 
// by 200,000,  that's on a dark map
// let map = L.map('mapid').setView([40.7, -94.5], 4);
